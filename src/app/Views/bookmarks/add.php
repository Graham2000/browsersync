...
<head>
    ...
    <title>New Bookmark - BrowserSync</title>
...
<div class="max-w-6xl mx-auto px-4 py-8 h-screen">
    ...
    <div class="grid grid-cols-3 gap-4 h-full">
        ...
        <div id="bookmark" class="h-full col-span-2 ml-8 p-6">
            ...
            <form class="mt-4 flex flex-col" action="/bookmarks" method="post">
                ...
                <input type="text" name="tags" placeholder="Enter Tags" class="w-full p-4 border border-gray-300 rounded-md">
